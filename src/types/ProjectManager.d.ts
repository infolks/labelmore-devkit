...
export interface ProjectManager {
     ...
     * @param data project options to create a project
     */
    create(data: ProjectFormData): Promise<boolean>

    /**
     * Update project preferences
     * @param data project preferences to update
     * @param opening whether opening a new project or not
     */
    update(data: Partial<ProjectFormData>, opening?: boolean): Promise<boolean>
    ...
    /**
     * Show the dialog to open .inp files from disk
     */
     ...
     */
    openFile(path: string): Promise<Project>
    /**
     * Open project from a file
     * @param dir path to the directory
     * @param filename name of the file
     */
    openFile(dir: string, filename: string): Promise<Project>
     ...
     * export the project
     */
    export(frame: Frame, project: Project): Promise<void>
}
